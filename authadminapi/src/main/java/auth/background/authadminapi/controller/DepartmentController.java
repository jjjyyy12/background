...
import auth.background.application.DepartmentAppService;

@RestController
@RequestMapping("/Department")
public class DepartmentController extends ControllerBase {
    @Resource
    private DepartmentAppService _service;
	
    @RequestMapping("/Get")
    public DepartmentDto Get(@RequestParam("id") String id)
    {
    ...
    {
    	List<DepartmentDto> dtos = _service.GetAllList();
    ...
    @RequestMapping("/GetChildrenByParent/{parentId}")
    public PagedObj GetChildrenByParent(String parentId, int startPage, int pageSize){
         List<DepartmentDto> result = _service.GetChildrenByParent(parentId, startPage, pageSize);
    ...
    @ResponseBody
    public ResultObj Create(@RequestBody DepartmentDto dto,HttpServletRequest request){
    ...
    @ResponseBody
    public ResultObj Edit(@RequestBody DepartmentDto dto,HttpServletRequest request){
       	ResultObj res = new ResultObj();
       	try{

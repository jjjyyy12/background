...
public class RoleController extends ControllerBase {
    ...
    public List<TreeCheckBoxModel> GetMenuTreeData(String id)
    {
    ...
    public List<RoleMenuDto> GetRowMenuForLeftMenu(String ids)
    {
    ...
    public List<String> GetUserRoleMenusUrls(String ids)
    {
        List<String> Ids = GetList(ids, ",");

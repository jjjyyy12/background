package auth.background.consumers;
...
public class ConsumersConfig implements ResourceLoaderAware, EnvironmentAware{
...
//	        dataSource.setMaxWait(maxWait);
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("auth.background.repositories.dao");
